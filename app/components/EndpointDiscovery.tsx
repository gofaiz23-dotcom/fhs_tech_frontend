...
export default function EndpointDiscovery() {
  ...
  const testEndpoints = [
    'https://fhs-tech-backend.onrender.com/api/admin/users',
    'https://fhs-tech-backend.onrender.com/api/admin/users/history',
    'https://fhs-tech-backend.onrender.com/api/admin/users/access',
    'https://fhs-tech-backend.onrender.com/api/users',
    'https://fhs-tech-backend.onrender.com/api/admin/user',
    'https://fhs-tech-backend.onrender.com/health',
    'https://fhs-tech-backend.onrender.com/api/health',
    'https://fhs-tech-backend.onrender.com/',
  ];
