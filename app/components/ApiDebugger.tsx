  ...
  return (
    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
      ...
      <div className="mt-3 text-xs text-gray-600">
        <p><strong>Current API Base URL:</strong> https://fhs-tech-backend.onrender.com/api</p>
        <p><strong>Login Endpoint:</strong> https://fhs-tech-backend.onrender.com/api/auth/login</p>
      </div>
    </div>
  );
}
