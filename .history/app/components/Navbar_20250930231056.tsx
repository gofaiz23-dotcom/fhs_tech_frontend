...
export default function Navbar() {
  ...
  return (
    <nav className="bg-purple-700 text-white item-center justify-center flex  px-6 py-10 shadow-md">
      ...
      <div className="flex items-center space-x-3">
        ...
        <ul className="hidden ml-20 md:flex space-x-6 ml-10 text-md font-medium">
          <Link
            href='/dashboard'
