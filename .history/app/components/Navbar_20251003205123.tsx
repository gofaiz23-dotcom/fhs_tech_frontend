    ...
    <>
      ...
      <div className="fixed top-0 z-30 transition-all duration-300 ease-in-out" style={{
        ...
        <ul className="hidden md:flex space-x-6 text-md font-medium justify-center flex-1 text-center">
         ...
         {/* Right: User Profile */}
         <div className="bg-gray-200 hidden rounded-md p-3 md:flex items-center space-x-4">
           {state.isAuthenticated && state.user ? (
             <div className="flex items-center space-x-3">
               ...
               <button
                 ...
                 className="bg-orange-600 hover:bg-orange-700 px-3 py-2 rounded-lg transition-colors text-sm font-medium"
               >
