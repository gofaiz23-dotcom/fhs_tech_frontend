...
return ( <nav className="bg-purple-700 text-white shadow-md w-full"> <div className="flex items-center justify-between px-6 py-4">
{/* Left: Logo */} <Link href="/" className="flex items-center"> <Image
    ...
    <ul className="hidden md:flex space-x-6 text-md font-medium justify-center flex-1 text-center">
      ...
      <div className="relative group">
        ...
        <div className="absolute left-0 mt-2 hidden group-hover:block bg-white text-gray-800 rounded shadow-md min-w-[160px]">
          <Link
            href="/products"
