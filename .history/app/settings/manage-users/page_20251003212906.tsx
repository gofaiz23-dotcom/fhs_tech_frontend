                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-4 gap-3">
                        {grantedMarketplaces.map((marketplace, i) => (
                          <div key={i} className="flex items-center p-3 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-4 gap-3">
                        {grantedShipping.map((shipping, i) => (
                          <div key={i} className="flex items-center p-3 bg-purple-50 border border-purple-200 rounded-lg">
